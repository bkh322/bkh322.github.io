...
<!-- 게시판 목록 시작 { -->
<div class="bo_gall_wrap"  oncontextmenu="return blockRightClick()">
<div id="bo_gall" >
    ...
    <ul id="gall_ul" class="gall_row">
        <?php for ($i=0; $i<count($list); $i++) {
         ...
         ?>
        <li  data-aos="zoom-out" class="<?php echo implode(' ', $classes); ?>">
  <!--      	<div class="view" ><? echo $list[$i]['wr_content'] ?></div>-->
            <div class="gall_box" >
